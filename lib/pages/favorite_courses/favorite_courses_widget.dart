...
import 'favorite_courses_model.dart';
export 'favorite_courses_model.dart';

class FavoriteCoursesWidget extends StatefulWidget {
  const FavoriteCoursesWidget({
    super.key,
  ...
  @override
  State<FavoriteCoursesWidget> createState() => _FavoriteCoursesWidgetState();
}

class _FavoriteCoursesWidgetState extends State<FavoriteCoursesWidget>
    with TickerProviderStateMixin {
  late FavoriteCoursesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FavoriteCoursesModel());
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                StreamBuilder<List<ShortTasksRecord>>(
